...
%w[cm22.csv cm20.csv].each do |file|
    ...
    csv.each do |row|
        ...
        if !c
            ...
            c.comm_address = "#{split_row[3]}, #{split_row[5]}, #{split_row[6]}, #{split_row[7]}"
            c.comm_zip = split_row[7].to_i
            c.comm_des = split_row[8]
            c.comm_type = split_row[9]
            c.comm_party = split_row[10]
            c.comm_cat = split_row[12]
            c.org_name = split_row[13]
            c.save
        end
    end
end
...
%w[cn20.csv cn22.csv].each do |file|
    ...
    csv.each do |row|
        ...
        if !p
            ...
            p.committee = Committee.find_by(comm_id: split_row[9])
